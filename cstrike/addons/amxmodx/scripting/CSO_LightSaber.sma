...
new g_MaxPlayers, g_Ham_Bot, RemWeapon[33]

public plugin_init() 
{
	register_plugin(PLUGIN, VERSION, AUTHOR)
	register_gxm_item("[KNIFE] Light Saber", "", 2000, 5, GUN_SECTION_KNIFE, 0, CSW_KNIFE)
