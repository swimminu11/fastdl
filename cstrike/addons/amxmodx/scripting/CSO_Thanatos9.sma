...
#define PLUGIN "THANATOS-9"
#define VERSION "1.0"
#define AUTHOR "extazY"
...
// Safety
new g_IsConnected, g_IsAlive, g_PlayerWeapon[33], RemKnife[33]

public plugin_init()
{
	register_plugin(PLUGIN, VERSION, AUTHOR)
	register_gxm_item("[KNIFE] Thanatos 9", "", 8900, 35, GUN_SECTION_KNIFE, 0, CSW_KNIFE)
	...
	RegisterHam(Ham_Killed, "player", "WhenKilled", 1);
	RegisterHam(Ham_Spawn, "player", "WhenSpawn", 1);
