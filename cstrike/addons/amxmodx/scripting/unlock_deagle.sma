...
new const WEAPON_V_MDL[] = "models/gunxpmod/v_deagle.mdl";
#define WEAPON_CSW CSW_DEAGLE
new const weapon_n[] = "weapon_deagle";
...
public plugin_init() 
{
	...
	register_gxm_item("Colt Trooper mk. III Deagle", "", 800, 7, GUN_SECTION_PISTOL, 0, CSW_DEAGLE)
